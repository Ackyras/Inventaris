        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{route('gedung.index')}}">List Gedung</a>
                        <a class="collapse-item" href="{{route('ruangan.index')}}">List Ruangan</a>
                        <a class="collapse-item" href="{{route('gedung.create')}}">Tambah Gedung</a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Ackyra's 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
